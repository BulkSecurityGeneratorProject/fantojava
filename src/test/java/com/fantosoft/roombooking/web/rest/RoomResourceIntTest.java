...
import com.fantosoft.roombooking.repository.RoomRepository;
...
public class RoomResourceIntTest {
    ...
    public void createRoom() throws Exception {
        ...
        assertThat(testRoom.getPhoto()).isEqualTo(DEFAULT_PHOTO);
        assertThat(testRoom.getPhotoContentType()).isEqualTo(DEFAULT_PHOTO_CONTENT_TYPE);
    }
    ...
    public void updateRoom() throws Exception {
        ...
        assertThat(testRoom.getPhoto()).isEqualTo(UPDATED_PHOTO);
        assertThat(testRoom.getPhotoContentType()).isEqualTo(UPDATED_PHOTO_CONTENT_TYPE);
    }
