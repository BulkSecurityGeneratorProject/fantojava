...
export class BookingService {
    ...
    private convertItemFromServer(booking: Booking): Booking {
        ...
        copy.from = this.dateUtils
            .convertLocalDateFromServer(booking.from);
        copy.until = this.dateUtils
            .convertLocalDateFromServer(booking.until);
        return copy;
    }
    ...
    private convert(booking: Booking): Booking {
        const copy: Booking = Object.assign({}, booking);
        copy.from = this.dateUtils
            .convertLocalDateToServer(booking.from);
        copy.until = this.dateUtils
            .convertLocalDateToServer(booking.until);
        return copy;
    }
}
